...
export var RCIMIWGroupReadReceiptVersion;
(function (RCIMIWGroupReadReceiptVersion) {
    /**
     * 未知版本
     */
    RCIMIWGroupReadReceiptVersion[RCIMIWGroupReadReceiptVersion["unknown"] = 0] = "unknown";
    /**
     * 群已读回执功能版本1
     */
    RCIMIWGroupReadReceiptVersion[RCIMIWGroupReadReceiptVersion["version1"] = 1] = "version1";
    /**
     * 群已读回执功能版本2
     */
    RCIMIWGroupReadReceiptVersion[RCIMIWGroupReadReceiptVersion["version2"] = 2] = "version2";
    /**
     * 群已读回执功能版本4
     */
    RCIMIWGroupReadReceiptVersion[RCIMIWGroupReadReceiptVersion["version4"] = 3] = "version4";
    /**
     * 已读回执功能版本5
     */
    RCIMIWGroupReadReceiptVersion[RCIMIWGroupReadReceiptVersion["version5"] = 4] = "version5";
...
export var RCIMIWReadReceiptStatus;
(function (RCIMIWReadReceiptStatus) {
    /**
      ---
      已读
      ---
 */
    RCIMIWReadReceiptStatus[RCIMIWReadReceiptStatus["read"] = 0] = "read";
    /**
      ---
      未读
      ---
 */
    RCIMIWReadReceiptStatus[RCIMIWReadReceiptStatus["unread"] = 1] = "unread";
 ...
 */
    ...
    /**
      ...
      ---
 */
    RCIMIWMessageType[RCIMIWMessageType["stream"] = 15] = "stream";
    /**
      ---
      原生自定义媒体消息
      ---
 */
    RCIMIWMessageType[RCIMIWMessageType["nativeCustomMedia"] = 16] = "nativeCustomMedia";
    /**
      ---
      群通知消息
      ---
 */
    RCIMIWMessageType[RCIMIWMessageType["groupNotification"] = 17] = "groupNotification";
    /**
      ---
      合并转发V2消息
      ---
 */
    RCIMIWMessageType[RCIMIWMessageType["combineV2"] = 18] = "combineV2";
...
export var RCIMIWMessageAuditType;
(function (RCIMIWMessageAuditType) {
    /**
      ---
      不需要送审，默认值
      ---
 */
    RCIMIWMessageAuditType[RCIMIWMessageAuditType["disallow"] = 0] = "disallow";
    /**
      ---
      需要送审
      ---
 */
    RCIMIWMessageAuditType[RCIMIWMessageAuditType["allow"] = 1] = "allow";
})(RCIMIWMessageAuditType || (RCIMIWMessageAuditType = {}));
export var RCIMIWReadReceiptOrder;
(function (RCIMIWReadReceiptOrder) {
    /**
      ---
      倒序
      ---
 */
    RCIMIWReadReceiptOrder[RCIMIWReadReceiptOrder["descending"] = 0] = "descending";
    /**
      ---
      正序
      ---
 */
    RCIMIWReadReceiptOrder[RCIMIWReadReceiptOrder["ascending"] = 1] = "ascending";
