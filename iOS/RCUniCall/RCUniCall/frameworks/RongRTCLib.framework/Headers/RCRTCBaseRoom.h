...
- (void)deleteRoomAttributes:(NSArray <NSString *> *)attributeKeys
                     message:(RCMessageContent *)message
                  completion:(RCRTCOperationCallback)completion DEPRECATED_MSG_ATTRIBUTE("use deleteAttributes:message:completion: API instead");
...
- (void)getRoomAttributes:(NSArray <NSString *> *)attributeKeys
               completion:(RCRTCAttributeOperationCallback)completion DEPRECATED_MSG_ATTRIBUTE("use getAttributes:completion: API instead");
