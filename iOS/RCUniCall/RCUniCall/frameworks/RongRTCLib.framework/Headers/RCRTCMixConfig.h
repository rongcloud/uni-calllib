...
/*!
 ...
 Added from 5.1.3
 */
- (void)setMixInputFilterByStreams:(nullable NSArray<RCRTCCustomLayout *> *)mixVideos mixAudios:(nullable NSArray<RCRTCCustomMixAudio *> *)mixAudios;
...
/*!
 ...
 Added from 5.1.3
 */
- (void)setMixInputFilterByRoomIds:(NSArray<NSString *> *)roomIds mixMediaType:(RCRTCMixMediaType)mixMediaType isAppend:(BOOL)isAppend;
